...
class TransactionControllerTest {
    ...
    void createTransaction_shouldReturnCreatedTransaction() throws Exception {
        ...
        Mockito.when(transactionService.createTransaction(Mockito.any())).thenReturn(createdTransactionDto);
    ...
    void updateTransaction_shouldReturnUpdatedTransaction() throws Exception {
        ...
        Mockito.when(transactionService.updateTransaction(Mockito.eq(transactionId), Mockito.any()))
    ...
    void getAllTransactions_shouldReturnList() throws Exception {
        ...
        mockMvc.perform(get("/api/transactions"))
                ...
                .andExpect(jsonPath("$[0].riskScore").value(5));
    }
}